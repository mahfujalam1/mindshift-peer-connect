const registrationSuccessEmailBody = (name: string, activationCode: number) => `
  <html>
    ...
    <body>
      <div class="container">
        <div class="header">
          <h1>Welcome to MindShift Peer Connect</h1>
        </div>
        <div class="content">
          <h2>Hello, ${name}</h2>

          <p>Thank you for registering with MindShift Peer Connect . To activate your account, please use the following activation code:</p>
